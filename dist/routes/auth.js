...
authRouter.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { email, password } = yield validation_schema_1.authSchemaValidation.validateAsync(req.body);
        ...
        const accesstoken = yield (0, jwt_helper_1.signAccessToken)(user._id);
